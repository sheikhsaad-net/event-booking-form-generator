<div class="container-fluid py-4 px-5">
        ...
        <div class="col-md-12">
          <div class="d-md-flex align-items-center mb-3 mx-2">
            <div class="mb-md-0 mb-3">
              <h2 class="font-weight-bold mb-0 text-2xl">Ciao, </h2>
            ...
            <button type="button" class="btn btn-sm btn-dark btn-icon d-flex align-items-center mb-0" style="display: none !important;">
              <span class="btn-inner--icon">
      ...
      <footer class="footer pt-3">
          <div class="row align-items-center justify-content-lg-between p-2">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-xs text-muted text-lg-start">
               Copyright © {{ now()->year }} Fondazione il Carro di Mirabella. Design by Sheikh Saad.
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <!-- <a href="#" class="nav-link text-xs text-muted">Privacy Policy</a> -->
                </li>
              </ul>
            </div>
          </div>
